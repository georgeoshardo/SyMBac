...
model_file_chambers = (
    "C:/DeepLearning/DeLTA_data/mother_machine/models/chambers_id_tessiechamp.hdf5"
)
...
training_set_seg = (
    "C:/DeepLearning/DeLTA_data/mother_machine/training/segmentation_set/train_multisets/"
)
training_set_track = (
    "C:/DeepLearning/DeLTA_data/mother_machine/training/tracking_set/train_multisets/"
)
...
write_mp4_movies = (
    True  # Whether to save MP4 movies showing the DeLTA segmentation & tracking results
)
